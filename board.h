 ...
 * Board identifier.
 */
#define BOARD_NAME                  "Kalman filter accelerator motherboard"
...
#define GPIOE_PIN2                  2
#define GPIOE_PIN3                  3
#define GPIOE_LED_R                 4
#define GPIOE_LED_G                 5
#define GPIOE_BUTTON                6
...
#define GPIOI_PIN0                  0
#define GPIOI_PIN1                  1
#define GPIOI_ISR_KALMAN            2
#define GPIOI_ISR_UART              3
#define GPIOI_PIN4                  4
#define GPIOI_PIN5                  5
#define GPIOI_PIN6                  6
#define GPIOI_PIN7                  7
...
#define VAL_GPIOD_MODER             (PIN_MODE_ALTERNATE(GPIOD_MEM_D2) |     \
                                     ...
                                     PIN_MODE_ALTERNATE(GPIOD_MEM_CS1) |    \
...
#define VAL_GPIOD_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOD_MEM_D2) |     \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOD_MEM_CS1) |    \
...
#define VAL_GPIOD_PUPDR             (PIN_PUPDR_FLOATING(GPIOD_MEM_D2) |     \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOD_MEM_CS1) |    \
...
#define VAL_GPIOE_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOE_SRAM_LB) |    \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOE_BUTTON) |     \
...
#define VAL_GPIOE_OSPEEDR           (PIN_OSPEED_100M(GPIOE_SRAM_LB) |       \
                                     ...
                                     PIN_OSPEED_100M(GPIOE_LED_G) |         \
                                     PIN_OSPEED_100M(GPIOE_BUTTON) |        \
...
#define VAL_GPIOE_PUPDR             (PIN_PUPDR_FLOATING(GPIOE_SRAM_LB) |    \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOE_LED_G) |      \
                                     PIN_PUPDR_PULLUP(GPIOE_BUTTON) |       \
...
#define VAL_GPIOI_MODER             (PIN_MODE_INPUT(GPIOI_PIN0) |           \
                                     ...
                                     PIN_MODE_ALTERNATE(GPIOI_ISR_KALMAN) |         \
                                     PIN_MODE_INPUT(GPIOI_ISR_UART) |       \
...
#define VAL_GPIOI_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOI_PIN0) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOI_ISR_KALMAN) |        \
                                     PIN_OTYPE_PUSHPULL(GPIOI_ISR_UART) |   \
...
#define VAL_GPIOI_OSPEEDR           (PIN_OSPEED_100M(GPIOI_PIN0) |          \
                                     ...
                                     PIN_OSPEED_100M(GPIOI_ISR_KALMAN) |             \
                                     PIN_OSPEED_100M(GPIOI_ISR_UART) |      \
...
#define VAL_GPIOI_PUPDR             (PIN_PUPDR_FLOATING(GPIOI_PIN0) |       \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOI_ISR_KALMAN) |         \
                                     PIN_PUPDR_PULLUP(GPIOI_ISR_UART) |     \
...
#define VAL_GPIOI_ODR               (PIN_ODR_HIGH(GPIOI_PIN0) |             \
                                     ...
                                     PIN_ODR_HIGH(GPIOI_ISR_KALMAN) |       \
                                     PIN_ODR_HIGH(GPIOI_ISR_UART) |         \
...
#define VAL_GPIOI_AFRL              (PIN_AFIO_AF(GPIOI_PIN0, 0) |           \
                                     ...
                                     PIN_AFIO_AF(GPIOI_ISR_KALMAN, 3) |                \
                                     PIN_AFIO_AF(GPIOI_ISR_UART, 0) |       \
